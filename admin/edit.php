...
$queri = "SELECT * FROM employee_acct WHERE userid = $emid";
$acct_query = mysqli_query($connection, $queri);
$rowac = mysqli_fetch_assoc($acct_query);
...
if (isset($_POST['editProfile'])) {
  ...
  if (!empty($_POST['password'])) {
    ...
    $querAcctUpdate = "UPDATE employee_acct SET `password`='$pass' WHERE userid = $emid";
    $updateAcct = mysqli_query($connection, $querAcctUpdate);
  }
              ...
              <div class="">
                <form class="" method="post" action="">
                  <div class="card-body">
                    ...
                    <div class="well">
                      <h6 class="text-divider"><span>Login Account Details</span></h6>

                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="form-label">User ID:</label>
                            <input type="text" class="form-control" value="<?php echo $emid; ?>" required placeholder="Enter username details..." disabled>
                            <input type="hidden" name="userid" value="<?php echo $emid; ?>">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="form-label">Password:</label>
                            <input name="password" type="password" class="form-control" placeholder="Enter New password details...">
                          </div>
                        </div>
                      </div>
