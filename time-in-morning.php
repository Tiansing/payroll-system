										...
										<div class="custom-header">
											<a href="index.php" class="btn btn-info back-button">
												< Back</a>
													...
													<h1 class="timein title text-center"><i class="fe fe-sunrise"></i>&nbsp;Time In Morning&nbsp;<i class="fe fe-sunrise"></i></h1>
						...
						<div class="row" style="padding-bottom: 40px;">
							...
							<div class="col" style="padding:30px;">
								...
								<form action="">
									...
									<input type="text" required="true" v-model="time_in_morning" class="form-control" name="start" class="input" id="result" onkeyup="showHint(this.value)" placeholder="Employee Identification here" style="text-align: center;" />
