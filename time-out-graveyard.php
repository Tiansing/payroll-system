										...
										<div class="custom-header">
											<a href="index.php" class="btn btn-info back-button">
												< Back</a>
													...
													<h1 class="timein title text-center">Time Out Graveyard</h1>
							...
							<script>
								...
								function showHint(str) {
									if (str.length == 0) {
										...
										xmlhttp.open("GET", "phpqrscan/ScanTimeOutGraveyard.php?q=" + str, true);
										xmlhttp.send();
									}
								}
							...
							<div class="col" style="padding:30px;">
								...
								<script>
									function fetchNewRecords() {
										$.ajax({
											url: 'phpqrscan/TimeOutGraveyard_new_records.php', // Your server-side script to fetch new records
											method: 'GET',
											dataType: 'html',
